            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        @endphp
                        <tr>
                            <td class="align-middle"><img src="/products/{{$cart->product->image}}" alt="" style="width: 50px;"></td>
                            ...
                            <td class="align-middle"><button class="btn btn-sm btn-primary"><a href="{{'remove_cart',$cart->id}}"><i class="fa fa-times"></i></a></button></td>
                        </tr>
                        @php
                        $total_price += $total_sub;
                    @endphp
                        @endforeach
